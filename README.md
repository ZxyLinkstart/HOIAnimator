...
**HumanML3D**
```shell
python -m eval.eval_humanml --model_path /root/zxy/InterHDM/motion-diffusion-model/save/ori_final/model000600000.pt
```

**KIT**
```shell
python -m eval.eval_humanml --model_path /root/zxy/InterHDM/motion-diffusion-model/save/body_obj_0803/model000030000.pt
```
</details>
