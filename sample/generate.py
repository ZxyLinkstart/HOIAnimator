...
"""
import sys
sys.path.append("/root/zxy/InterHDM/motion-diffusion-model")
import os
...
def main():
    ...
    if is_using_data:
        ...
        # collate_args = [{'inp': torch.zeros(n_frames), 'tokens': None, 'lengths': n_frames,'gt_mesh':None,'motion_lable':None,'obj_lable':None}] * args.num_samples
        collate_args = [{'inp': torch.zeros(n_frames), 'tokens': None, 'lengths': n_frames,'motion_lable':None,'obj_lable':None}] * args.num_samples
    ...
    for rep_i in range(args.num_repetitions):
        ...
        import joblib
        joblib.dump(sample,"/root/zxy/InterHDM/motion-diffusion-model/out_ori/chair_sit_5.pkl")
